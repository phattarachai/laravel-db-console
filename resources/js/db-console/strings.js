...
export const DEFAULT_STRINGS = {
  ...
  'grid.showingServer': 'Showing :from–:to',
  'grid.showingServerMore': 'Showing :from–:to of many',
  'grid.pageOnly': 'Page :current',

  // Filter builder (FilterBar) — per-field filters over the whole table
  ...
  'filter.from': 'From',
  'filter.to': 'To',
  'filter.listHint': 'value, value, …',
  'filter.searchColumns': 'Search columns…',
  'filter.noColumns': 'No column matches “:search”',
  'filter.op.eq': '=',
  'filter.op.ne': '≠',
  'filter.op.lt': '<',
  'filter.op.lte': '≤',
  ...
  'filter.op.ends': 'ends with',
  'filter.op.in': 'in',
  'filter.op.nin': 'not in',
  'filter.op.between': 'between',
  'filter.op.is_null': 'is null',
  'filter.op.not_null': 'is not null',
  'filter.op.is_true': 'is true',
  'filter.op.is_false': 'is false',
